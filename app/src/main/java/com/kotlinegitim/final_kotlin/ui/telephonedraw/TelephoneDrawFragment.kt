package com.kotlinegitim.final_kotlin.ui.telephonedraw
...
class TelephoneDrawFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val root = inflater.inflate(R.layout.fragment_telephone_draw,null,true)

        drawListview = root.findViewById(R.id.listDraw5)
        ...
        FirebaseService().GetValues("Draws5")
       ...
       val adapter = DrawsListCustomAdaptor(requireActivity(),R.layout.draw_custom_layout, listDraw2 )
        ...
        database.child("Draws5").addValueEventListener(object : ValueEventListener {
